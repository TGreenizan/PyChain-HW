...
sender_wallet=st.text_input('Sender Wallet')

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_wallet=st.text_input('Receiver Wallet')

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_transfer= st.number_input('Amount of transfer')
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(sender_wallet,receiver_wallet,amount_transfer),
        creator_id=42,
